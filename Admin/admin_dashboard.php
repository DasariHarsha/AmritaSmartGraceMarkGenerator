<?php
    ...
    $name = $_SESSION['name1'];
    // Query the database
    $sql = "SELECT Name FROM administrator WHERE adminID='$id'";
...
<html lang="en">
  ...
  <body>
    ...
    <div class="dashboard_txt">
        <h3 class="heading_1" style="font-weight: bold; text-align: left; margin-left: 50px; margin-top: 30px;"> Welcome : <?php echo $name1; ?></h3>
    </div>
    <div class="d-flex justify-content-end" style="padding-right: 5cm; margin-top: -0.5cm">
        <button type="submit" class="btn btn-danger btn-submit" ><a href="admin_manage_acc.php" style="color: white;">Manage Accounts</a></button>
    </div><hr>
    <div style="padding-top: 25px;">
        <h3><img src="https://cdn.pixabay.com/photo/2013/07/13/13/38/man-161282_640.png" style="width: 30px; margin-left: 50px;"> <b> Admin Details </b> </h3>
    </div>
    <table class="table table-bordered table-striped" style="width: 80%; margin-left: auto; margin-right: auto; margin-top: 35px;">
        ...
        <tbody>
          <tr>
            <td>123456</td>
            <td>01/01/1990</td>
            <td><span class="badge bg-success">1 Request</span></td>
          </tr>
        </tbody>
    </table>
