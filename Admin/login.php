<?php
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $collegeid = $_POST['admin_Id']; 
    $administratorPassword = $_POST['password'];
    
    $log = "SELECT * from `administrator` WHERE adminID = '$collegeid' AND Password = '$administratorPassword';";
    ...
    if($num == 1){
      $login = true;
	  $fetchAdminName = mysqli_query($conn, "SELECT Name FROM `administrator` WHERE adminID = '$collegeid';");

      session_start();
      $_SESSION['loggedin'] = true;
      $_SESSION['name1'] = mysqli_fetch_assoc($fetchAdminName)['Name'];
    ...
    <div class="container d-flex align-items-center justify-content-center" style="height: 100vh;">
        <div class="card shadow-lg" style="width: 400px;">
          ...
          <div class="card-body">
            <form action="#" method="POST">
              <div class="form-group position-relative mb-4">
                ...
                <input type="text" id="username" class="form-control rounded-pill" placeholder="Enter your username" name="admin_Id">
          ...
          <div class="card-footer text-center" style="background: #f9f9f9;">
            <p class="mb-0">Forgot Password? <a href="reset_password.php" target="_blank" class="text-primary">Reset</a></p>
          </div>
        </div>
      </div>
  </body>
