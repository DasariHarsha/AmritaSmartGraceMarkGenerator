<?php
  ...
  // Connect to database
    ...
    $dob = $_POST['dob'];
    // Query the database
    $sql = "UPDATE `student` SET `EmailID`='$Email',`PhoneNum`='$phone',`Address`='$address',`DOB`='$dob' WHERE RollNum = '$id'";
              ...
              <div class="card-body">
                ...
                <form  action="#" method="POST">
                    ...
                    <div class="d-grid gap-2 col-6 mx-auto">
                        <button class="btn btn-primary" type="submit" onclick="alert('Profile has been changed Successfully')">Save Changes</button>
                    </div>
                </form>
              </div>
            </div>
