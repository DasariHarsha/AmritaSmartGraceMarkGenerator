...
if(isset($_REQUEST['pwdrst']))
{
  ...
  if($pwd == $cpwd)
  {
    $reset_pwd = mysqli_query($connection,"update student set Password='$pwd' where EmailID='$email'");
    if($reset_pwd>0)
    {
...
if($_GET['secret'])
{
  ...
  $check_details = mysqli_query($connection,"select EmailID from student where email='$email'");
