<?php
    ...
    $name = $_SESSION['name'];
    // Query the database
    $sql = "SELECT FacultyID, DOB FROM faculty WHERE FacultyID='$id'";
    $result = mysqli_query($conn, $sql);
    $sql1 = "SELECT EmailID, PhoneNum, Address FROM faculty WHERE FacultyID='$id'";
    $result1 = mysqli_query($conn, $sql1);
    $sql10 = "SELECT * FROM upload_docs";
...
<html lang="en">
  ...
  <body>
                ...
                <ul class="nav justify-content-end nav-tabs">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a class="dropdown-item" href="Graphs1.php">Graphs</a></li>
                          <li><hr class="dropdown-divider"></li>
                          <li><a class="dropdown-item" href="counceling.php">Counceling</a></li>
                          <li><hr class="dropdown-divider"></li>
    ...
    <div style="padding-top: 25px;">
        <h3><img src="https://cdn.pixabay.com/photo/2013/07/13/13/38/man-161282_640.png" style="width: 30px; margin-left: 50px;"> <b> Faculty Details </b> </h3>
    </div>
    <table class="table table-bordered table-striped" style="width: 80%; margin-left: auto; margin-right: auto; margin-top: 35px;">
        <thead class="table-dark">
          <tr>
            <th><img src="588a64e0d06f6719692a2d10.png" style="width: 27px; margin-right: 8px;">ID</th>
            ...
            <th><img src="https://www.citypng.com/public/uploads/preview/white-notification-bell-icon-transparent-background-11638985030nycenfyruw.png" style="width: 27px; margin-right: 8px;">Requests</th>
          </tr>
        </thead>
        <tbody>
          <?php
