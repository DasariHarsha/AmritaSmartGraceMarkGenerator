<?php
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $collegeid = $_POST['faculty_id']; 
    $StudentPassword = $_POST['password'];
    
    $log = "SELECT * from `faculty` WHERE FacultyID = '$collegeid' AND Password = '$StudentPassword';";
    ...
    if($num == 1){
      $login = true;
	  $fetchAdminName = mysqli_query($conn, "SELECT Name FROM `faculty` WHERE FacultyID = '$collegeid';");
          ...
          <div class="card-body">
            <form action="#" method="POST">
              <div class="form-group position-relative mb-4">
                ...
                <input type="text" id="username" class="form-control rounded-pill" placeholder="Enter your username" name="faculty_id">
