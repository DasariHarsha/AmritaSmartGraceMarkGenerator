<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if ($pa1==$pa2){
            $sql = "UPDATE `faculty` SET `Password`='$pa2' WHERE EmailID = '$mail'";
          ...
          <div class="col-md-6">
            <div class="form-box">
              ...
              <form action="#" method="POST">
                ...
                <button type="submit" class="btn btn-primary btn-block" onclick="alert('Password Has been changed Successfully')">Reset Password</button>
              </form>
            </div>
          </div>
        </div>
