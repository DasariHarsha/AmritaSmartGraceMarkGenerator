<?php
  ...
  // Connect to database
    ...
    $sql1="INSERT INTO `faculty_request`(`id`, `name`, `email`, `event`, `description`, `gracemark`, `filename`) VALUES ('$id','$name','$Email','$Event','$description','$grace_mark','$FileName')";
    $result1 = mysqli_query($conn, $sql1);
		...
		if($fileExtension == 'pdf'){
			...
			$fileDestination = "D:\\DontChange\\htdocs\\Smart_Grace_Mark_Generator\\Admin\\admin_view_requests\\".$fileNewName.'.pdf';
			move_uploaded_file($fileTempName, $fileDestination);

			$displayFileUploaded = true;

			$insertFile = "INSERT INTO `faculty_docs` values('$clientID', '$fileName', '$fileNewName','$fileDestination');";
    ...
    <div class="shadow-box">
      <form onsubmit="return validateForm()" action="#" method="POST"  enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="textarea" class="form-control" id="description" name="description" placeholder="Enter your description">
        </div>
        <div class="mb-3">
          <label for="gm" class="form-label">Grace Marks</label>
          <input type="text" class="form-control" id="gm" name="gm" placeholder="Enter gracemarks to be alloted">
        </div>
        <!-- <div class="mb-3">
